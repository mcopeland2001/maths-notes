...
\searchableSubsection{Finite Sets of Vectors}{vector spaces}{	
	...
	\bigskip
	\subsubsection{Quotient Spaces in Finite-Dimensional Vector Spaces}
	\boxeddefinition{The subspace $W'$ of $V$ such that ${ W \oplus W' = V }$ is called the \textbf{quotient space of $V$ by $W$} and is denoted ${ V/W }$.}
