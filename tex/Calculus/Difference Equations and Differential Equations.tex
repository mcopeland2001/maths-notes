...
%---------- 
		...
		\TODO{
			\begin{itemize}
				\item{Solutions to linear systems form a linear vector space}
				\item{Eigenvectors/values give \textbf{all} possible solutions}
				\item{Complex and repeated eigenvalues}
			\end{itemize}	
		}
	}
