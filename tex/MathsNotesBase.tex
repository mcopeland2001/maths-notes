...
% init code for algorithmic package
...
\newcommand\subsubsubsection[1]{{\fontfamily{pbk}\selectfont
		\textit{#1}\nopagebreak\\[4pt]\nopagebreak
}}% this is the level below the last toc/bookmark level
...
\newcommand{\nn}{\\[6pt]}
\newcommand{\nnn}{\\[8pt]}
\newcommand{\nl}[1][]{% from https://stackoverflow.com/questions/2144176/latex-newcommand-default-argument-is-empty
...
\DeclareRobustCommand{\B}[1]{\mathbb{B}^{#1}}
...
\newcommand{\modulus}[1]{\abs{#1}} % semantic alias of \abs for complex conjugate
...
\newcommand{\boxeddefinition}[1]{\noindent\fbox{% TODO: add label argument and put label in environment
		\parbox{\textwidth}{%
			\begin{definition}
				#1
			\end{definition}	
