...
\newcommand\subsubsubsection[1]{\textbf{\textit{#1}}\\[8pt]}% this is the level below the last toc/bookmark level
...
%\newcommand*\xbar[1]{% from https://latex.org/forum/viewtopic.php?t=20717
%	\hbox{%
%		\vbox{%
