   ...
   \end{cases}
	...
	\searchableSubsection{Complex Number}{number theory, complex numbers}{\bigskip
		...
		\begin{tcolorbox}[breakable,enhanced jigsaw,colframe=white,colback=white,boxrule=0pt,arc=0pt,left=0pt,right=0pt,top=0pt,bottom=0pt]
			\labeledProposition{The conjugate of a product of complex numbers is equal to the product of their conjugates.}{conjugate-of-complex-product-equal-to-product-of-conjugates}
			\begin{proof}
				\[\begin{aligned}
