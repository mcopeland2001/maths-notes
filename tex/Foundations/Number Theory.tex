	...
	\searchableSubsection{Complex Numbers}{number theory, complex numbers}{
		...
		\labeledProposition{Properties of the modulus of complex numbers (${ z,z_1,z_2 }$ refer to complex numbers):
			\begin{enumerate}[label=(\roman*)]
				...
				\item{${ \modulus{z} \geq \RePart(z) \land \modulus{z} \geq \ImPart(z) }$.}
				\item{${ \modulus{z_1z_2} = \modulus{z_1}\modulus{z_2} }$.}
				\item{${ \modulus{z_1 + z_2} \leq \modulus{z_1} + \modulus{z_2} }$.}
			\end{enumerate}
		...
		\begin{proof}\nl
			...
			\begin{enumerate}[label=(\roman*)]
				...
				\item{From the definition, if ${ z = a + bi }$ then ${ \RePart(z) = a }$ and ${ \ImPart(z) = b }$ and the modulus,
				...
				\item{\TODO{prove triangle inequality for complex modulus: https://tutorial.math.lamar.edu/Extras/ComplexPrimer/ConjugateModulus.aspx}}
			\end{enumerate}
		\end{proof}
