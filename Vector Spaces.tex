...
\searchableSubsection{Infinite Sets of Vectors}{vector spaces, analysis}{	
	...
	\note{It can be shown, using the Axiom of Choice, that every vector space has a basis but a basis of $\R{\infty}$ will be uncountably infinite and so will not be expressable as ${ (\V{v_1},\V{v_2},\dots) }$.}
