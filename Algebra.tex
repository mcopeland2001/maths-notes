...
\searchableChapter{Algebra}{abstract algebra, complex numbers}
	...
	\searchableSubsection{Products Groups and Quotient Groups}{abstract algebra, modular arithmetic}{
		...
		\begin{exe}
			\ex{There is a group with subgroups of orders ${ 1 \dots 12 }$. It is a direct product of cyclic groups of orders ${ 2 \times 2 \times 2 \times 3 \times 3 \times 5 \times 7 \times 11 = \cardinality{G} = 27,720 }$ so it looks like,
