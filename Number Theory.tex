...
\begin{document}
\searchableChapter{Number Theory}{number theory}

	\searchableSection{Natural Numbers}{number theory}
			
		\searchableSubsection{Peano Axioms}{number theory}{
		...
		\subsubsection{Properties following from these axioms}		
	...
	\searchableSubsection{\sectionTitle{Integers}}{number theory}{\bigskip}
		...
		\searchableSubsection{Absolute Value}{number theory, absolute value}{\label{ssection:absolute-value}\bigskip
