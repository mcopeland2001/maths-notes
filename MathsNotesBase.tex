...
\usepackage{subfiles}
%\usepackage[depth=4,open,openlevel=1]{bookmark}
...
\usepackage{lmodern}
\usepackage{amsfonts}
\usepackage{epstopdf}%[outdir=./resources/img/]
...
\newcommand\subsubsubsection[1]{\paragraph{#1\\\\}}% this is the level below the last toc/bookmark level
