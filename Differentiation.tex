...
%		\[ A\vtheta = (b,a,0,\dots,0)^T. \]
		...
		\TODO{
			\begin{enumerate}
				\item{show how any value of t produces an eigenfunction}
				\item{show that the eigenvalues of these eigenfunctions are the derivatives of the exponents}
				\item{deduce that any exponent with the same derivative is therefore in the same eigenspace (these will be solutions to homogeneous diff eqs?)}
			\end{enumerate}
		}
